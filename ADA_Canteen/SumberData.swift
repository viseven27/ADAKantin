...
struct TenantData {
    static let allTenants: [TenantItem] = [
        TenantItem(id: 1,
                   ...
                   minPrice: 18000,
                   maxPrice: 30000,
                   tags: ["kategori.Ayam", "kategori.Sapi", "kategori.Sayur"],
        ...
        TenantItem(id: 4,
                   ...
                   foodItems: [
                    FoodItem(name: "Bebek Goreng",
                             ...
                             tenantId: 4),
                    FoodItem(name: "Nasi + Bebek Goreng 2",
                             price: 35000,
                             image: "paket.bebek.goreng.rinjani",
                             tags: ["kategori.Ayam", "kategori.Cabe"],
                             location: "Bebek Goreng Rinjani",
                             foodDescription: "Nasi dengan 2 bebek goreng krispi + bumbu khas Rinjani",
                             tenantId: 4)
                   ]),
        TenantItem(id: 5,
                   name: "Kantin Kasturi",
        ...
        TenantItem(id: 7,
                   ...
                   foodItems: [
                    FoodItem(name: "Ayam Madu",
                             ...
                             tenantId: 7),
                    FoodItem(name: "Nasi Uduk Komplit",
                             price: 20000,
                             image: "nasiUdukKedaiLaris",
                             tags: [ "kategori.Ayam", "kategori.Sayur"],
                             location: "Kedai Laris",
                             foodDescription: "Nasi uduk komplit bikin kenyang buatan Kedai Laris.",
                             tenantId: 7)
                   ]),
        TenantItem(id: 8,
        ...
        TenantItem(id: 9,
                   ...
                   foodItems: [
                    FoodItem(name: "Ayam Sambal Ijo",
                             ...
                             tenantId: 9),
                    FoodItem(name: "Ayam Saus Orange",
                             price: 7000,
                             image: "ayam.orange",
                             tags: [ "kategori.Ayam"],
                             location: "Dapoer Cowek",
                             foodDescription: "Ayam saus orange yang dagingnya berkualitas dan segar buatan Dapoer Cowek.",
                             tenantId: 9)
                   ]),
        TenantItem(id: 10,
                   name: "Mama Djempol",
